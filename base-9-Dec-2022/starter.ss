...
1977 # min yr for sdreport outputs (-1 for styr); #_1975
2020 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2020
...
4 # Annual_F_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Apical_F's); 4=true F for range of ages; 5=unweighted avg. F for range of ages
 3 12 #_min and max age over which average F will be calculated, with F=Z-M
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1643870955
