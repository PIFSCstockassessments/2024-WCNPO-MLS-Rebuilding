F##  Script filename = Build Input File_test_model_2.R
...
RecruitType <- c(2) ## The ordered vector RecruitType includes model 3
RecFac <- 1000 ## RecFac is a multiplier to convert units of recruit model output (e.g., 1000 fish) to AGEPRO numbers of fish
SSBFac <- 1 ## SSBFac is a divisor to convert kg of SSB in AGEPRO to recruit model input units of SSB (e.g., 1000 mt)
