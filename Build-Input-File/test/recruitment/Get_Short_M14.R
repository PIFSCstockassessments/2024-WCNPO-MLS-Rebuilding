## R Script filename = Get_Short_M14.R
...
## Note: Set SSBFac <- 1 for empirical recruits per spawner models 2, 4, 5, 14 given the SS3 extraction code
SSBFac <- 1 
...
AGEPRO_INP(output.dir = "C:\\Users\\jon.brodziak\\Desktop\\2024 WCNPO MLS Rebuilding\\Build-Input-File",
                    ...
                    RefPointJan1 = 0,
                    RefPointMidYr = 0,
                    RefPointF = 0.914,    # RefPointF = FLim/F2020 = 0.53/0.58  
                    SetBounds = TRUE,
                    MaxWeight = 250,
                    MaxNatM = 1,
                    SumReport = 1,
