...
#' @param ScaleFactor Scaling factor for [1] Biomass, [2] Recruits, and [3] Stock numbers
...
AGEPRO_INP<-function(output.dir = "",
  ...
  if (!dir.exists(output.dir)) {
    ...
    message("Directory", output.dir, "created.\n")
  } else {
    message("Directory", output.dir, "already exists.\n")
  }
