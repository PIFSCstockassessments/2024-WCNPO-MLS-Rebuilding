## R Script filename = make_Phased_Q_template_MT.R
## Purpose: Extract input data and build an AGEPRO input file
## for a 2-phase catch-based projection using YearAvg = [2020,2020]
## Produces P(SSB rebuild in 2034) >= 0.60 at Phased-Qrebuild using medium-term recruitment
## 4-Apr-2024
