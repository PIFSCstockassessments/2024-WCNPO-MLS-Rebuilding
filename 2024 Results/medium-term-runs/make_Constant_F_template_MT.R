## R Script filename = make_Constant_F_template_MT.R
## Purpose: Extract input data and build an AGEPRO input file
## for a constant fishing mortality Frebuild=0.38 projection using YearAvg = [2020,2020]
## Produces P(SSB rebuild in 2034) >= 0.60 at Frebuild using medium-term recruitment
## 4-Apr-2024
