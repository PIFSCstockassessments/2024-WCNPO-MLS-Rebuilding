## R Script filename = make_Constant_Q_template_ST.R
...
## Produces P(SSB rebuild in 2034) >= 0.60 at Qrebuild using short-term recruitment
## 4-Apr-2024
...
# Set constant catch biomass quota constant Q  (mt)
ConstantQ <- 1400
