...
## Read in the Scenario 1 catch biomass by fleet group for 2025-2027
FleetGroupCatch2025_2027 <- read.csv("C:\\Users\\jon.brodziak\\Desktop\\2024 WCNPO MLS Rebuilding\\2025 MLS projections\\BSIA Catch\\scenario1-catch.csv", header=TRUE)
...
## The CMM 2024 phase runs from 2025 to 2027 at quotas of Q = (2400, 2400, 2400) mt
## Catches read from file=scenario1-catch.csv
## The second phase runs from 2028 to 2031 at a quota of Q = 2300 mt
## The third phase runs from 2032 to 2034 at a quota of Q = 2200 mt

TotalCatchPhase2 <- 2300
