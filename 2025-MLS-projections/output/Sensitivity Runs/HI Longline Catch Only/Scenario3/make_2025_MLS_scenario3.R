## R Script filename = make_2025_MLS_scenario3.R
...
## Read in the Scenario 3 catch biomass by fleet group for 2025-2027
FleetGroupCatch2025_2027 <- read.csv("C:\\Users\\jon.brodziak\\Desktop\\2024 WCNPO MLS Rebuilding\\2025 MLS projections\\BSIA Catch\\scenario3-catch.csv", header=TRUE)
...
# By fleet group read from file "scenario3-catch.csv"
