...
df1 <- SSInput$CatchbyFleet

# Write catch biomass by fleet to a CSV file
write_csv(df1, "CatchbyFleet.csv")

df2 <- SSInput$FbyFleet

# Write fishing mortality by fleet to a CSV file
write_csv(df2, "FbyFleet.csv")
