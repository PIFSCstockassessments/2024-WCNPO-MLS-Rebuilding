## R Script filename = make_Constant_Q_template.R
## Purpose: Extract input data and build an AGEPRO input file
## for a constant catch biomass quota projection Q=2175 mt using YearAvg = [2020,2020]
## Produces P(SSB rebuild in 2034) = 0.XX at Q=(2175)
## 26-Mar-2024
...
# Set constant catch biomass quota constant Q=2175  (mt)
ConstantQ <- 2175
