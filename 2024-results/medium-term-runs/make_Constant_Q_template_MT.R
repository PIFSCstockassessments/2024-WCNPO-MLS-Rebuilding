## R Script filename = make_Constant_Q_template_MT.R
## Purpose: Extract input data and build an AGEPRO input file
## for a constant catch biomass quota projection Qrebuild mt using YearAvg = [2020,2020]
## Produces P(SSB rebuild in 2034) >= 0.60 at Qrebuild using medium-term recruitment
## 4-Apr-2024
